...
(function (global) {
  ...
  const MATH_SYMBOLS = [
    ...
    { id: 'str-10', group: 'structure', symbol: '(', command: '\\left(', katexProbe: '\\left( x \\right)', name: 'delimitador izquierdo', keywords: ['delimitador izquierdo', 'matematica', 'structure'] },
    { id: 'str-11', group: 'structure', symbol: ')', command: '\\right)', katexProbe: '\\left( x \\right)', name: 'delimitador derecho', keywords: ['delimitador derecho', 'matematica', 'structure'] },
    { id: 'str-12', group: 'structure', symbol: 'Big', command: '\\Big', katexProbe: '\\Big( x \\Big)', name: 'delimitador grande', keywords: ['delimitador grande', 'matematica', 'structure'] },
